   ...
   private String meetingType=null;
    ...
    private void initiateMeeting(String meetingType, String receiverToken) {
        try {
            ...
            sendRemoteMessaging(body.toString(), Constants.REMOTE_MSG_INVITATION);
    ...
    private void sendRemoteMessaging(String remoteMessageBody, String type) {
    ...
    private void cancelInvitation(String reveiverToken) {
        try {
            JSONArray tokens = new JSONArray();
            tokens.put(reveiverToken);
            JSONObject body = new JSONObject();
            JSONObject data = new JSONObject();
            ...
            body.put(Constants.REMOTE_MSG_DATA, data);
            body.put(Constants.REMOTE_MSG_REGISTRATION_IDS, tokens);
            sendRemoteMessaging(body.toString(), Constants.REMOTE_MSG_INVITATION_RESPONSE);
        } catch (Exception exception) {
            Toast.makeText(this, exception.getMessage(), Toast.LENGTH_SHORT).show();
            finish();
        }
